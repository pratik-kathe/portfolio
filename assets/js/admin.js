...
(function () {
  ...
  var STUDY_SCHEMA = [
    ...
    F("text", "thumbnail", "Card thumbnail — image URL or data-URI (16:10; empty = no image)"),
    L("metrics", "Card metric chips (shown on work cards)",
      [F("text", "value", "Value (e.g. 35–40%)"), F("text", "label", "Label")],
      { value: "", label: "" }),
    F("text", "impact", "Card outcome line (fallback when no metric chips)"),
  ...
  var SITE_SCHEMA = [
    ...
    F("lines", "hero.chips", "Keyword chips (one per line, under the subtitle)"),
